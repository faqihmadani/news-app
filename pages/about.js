        ...
        <div>
            ...
            <div className="md:pt-28 pt-32 w-11/12 md:w-10/12 lg:w-9/12 xl:w-8/12 mx-auto">
                ...
                <p className="text-md text-center mt-2">
                    This website is made by Faqih Madani using Next JS, Tailwind CSS, and <a className="underline" rel="noreferrer" target="_blank" href="https://newsapi.org/"> News API</a>.
                </p>
            </div>
            <p>
